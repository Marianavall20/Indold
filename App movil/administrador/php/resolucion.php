     ...
     <!--Item menú-->
          <ul class="list-unstyled">
                    ...
                    <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-page"></i>Normas ambientales</a>
                      <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                        ...
                        <li class="active"><a href="resolucion.php">Resoluciones</a></li>
                      </ul>
                    </li>
        ...
        <div class="content-inner">
          ...
          <header class="page-header" id="caja1">
            <div class="container-fluid">
              <h2 class="no-margin-bottom" id="sub">Resoluciones sobre el agua</h2>
            </div>
          </header>
          ...
          <a  class="caja1" href="http://www.minambiente.gov.co/images/GestionIntegraldelRecursoHidrico/pdf/Legislaci%C3%B3n_del_agua/Ley_23_de_1973.pdf" target="_blank">
           Resolución 023 de 1973 
          </a>

          <a  class="caja2" href="http://www.minambiente.gov.co/images/GestionIntegraldelRecursoHidrico/pdf/Legislaci%C3%B3n_del_agua/Resoluci%C3%B3n_104.pdf" target="_blank">
          Resolución 104 de 2003
          </a>
          
          <a  class="caja3" href="http://www.minambiente.gov.co/images/GestionIntegraldelRecursoHidrico/pdf/Legislaci%C3%B3n_del_agua/Resoluci%C3%B3n_2145_2005.pdf" target="_blank">
          Resolución 2145 de 2005
          </a>

          <a  class="caja4" href="http://www.minambiente.gov.co/images/GestionIntegraldelRecursoHidrico/pdf/Legislaci%C3%B3n_del_agua/Resoluci%C3%B3n_872.pdf" target="_blank">
          Resolución 872 de 2006
          </a>

          <a  class="caja5" href="http://www.minambiente.gov.co/images/GestionIntegraldelRecursoHidrico/pdf/Legislaci%C3%B3n_del_agua/Resoluci%C3%B3n_2115.pdf" target="_blank">
          Resolución 2115 de 2007
          </a>

          <a  class="caja6" href="http://www.minambiente.gov.co/images/GestionIntegraldelRecursoHidrico/pdf/Legislaci%C3%B3n_del_agua/Resoluci%C3%B3n_075_de_2011.pdf" target="_blank">
