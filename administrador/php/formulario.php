      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
         ...
         <!--Item menú-->
          <ul class="list-unstyled">
                    ...
                    <li class="active"><a href="formulario.php"> <i class="icon-padnote"></i>Formulario Trabajador </a></li>
        ...
        <div class="content-inner">
          ...
          <header class="page-header" id="caja1">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Formulario</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center" id="caja_mayor">
                      <h3 class="h4">Registro De Trabajador</h3>
                    </div>
                    <div class="card-body" id="formulario">
                      <form class="form-horizontal" method="POST" action="../crud/registrar.php">
                        ...
                        <div class="line"></div>
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">Estado en la empresa</label>
                          <div class="col-sm-9">
