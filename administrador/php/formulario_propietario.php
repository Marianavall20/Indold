        ...
        <nav class="side-navbar">
         ...
         <!--Item menú-->
          <ul class="list-unstyled">
                    ...
                    <li class="active"><a href="formulario_usuario.php"> <i class="icon-padnote"></i>Formulario Usuario </a></li>
                    <li><a href="codigo.php"> <i class="icon icon-bars"></i>Código del contador </a></li>
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center" id="caja_mayor">
                      <h3 class="h4">Registro De Usuario</h3>
                    </div>
                    <div class="card-body" id="formulario">
                      <form class="form-horizontal" method="POST" action="../crud/registrar_propietario.php">
                        ...
                        <div class="line"></div>
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">Primer Apellido</label>
                          <div class="col-sm-9">
                            <input type="password" name="primer_apellido" class="form-control">
                        </div>
                        </div>
                        <div class="line"></div>
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">Segundo Apellido</label>
                          <div class="col-sm-9">
                        ...
                        <div class="line"></div>
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">Número del contador</label>
                          <div class="col-sm-9">
                            <input type="text" name="num_contador" class="form-control">
                          </div>
                        </div>
                        <div class="line"></div>
